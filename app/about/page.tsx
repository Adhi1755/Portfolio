        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 items-center mb-16 sm:mb-24 lg:mb-32">
          <div ref={leftRef} className="flex flex-col gap-6">
            ...
            <div className="space-y-3 sm:space-y-4 text-md sm:text-md lg:text-lg font-light leading-relaxed text-gray-600 dark:text-gray-400">
              <p>I am a <span className="text-black dark:text-white font-normal">pre-final year B.Tech student majoring in Computer Science Engineering (Data Science)</span> at Dayananda Sagar University, Bengaluru, with a current <span className="text-black dark:text-white font-normal">CGPA of 8.74</span>.</p>
            ...
            <div className="flex flex-wrap items-center gap-3 pt-2">
              ...
              <a href="/Adithya_N.pdf" target="_blank" rel="noopener noreferrer" download className="flex items-center gap-2 px-6 py-3 rounded-full border border-gray-300 dark:border-zinc-600 text-gray-700 dark:text-gray-300 font-light text-sm tracking-wide hover:border-black dark:hover:border-white hover:text-black dark:hover:text-white transition-all duration-200">
          ...
          <div ref={rightRef} className="flex justify-center lg:justify-end">
            <div className="relative w-full max-w-[320px] sm:max-w-[400px] lg:max-w-[420px] aspect-[3/4]">
              <div className="absolute -top-3 -left-2 sm:-left-4 z-20 flex items-center gap-2 sm:gap-2.5 bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-700 rounded-2xl px-3 sm:px-4 py-2 sm:py-2.5 shadow-lg shadow-black/5">
                ...
                <div><p className="text-[11px] sm:text-xs font-medium text-black dark:text-white leading-tight">CGPA 8.74</p><p className="text-[9px] sm:text-[10px] text-gray-400 leading-tight">DSU Bengaluru</p></div>
              </div>
